...
public class Constants {
	...
	public static final String MAIL_ERROR_VIEW = "mailError";
	public static final String ERROR_VIEW = "errorForm";
	
	public static final String ERROR_PATH = "error";

	public static final String SUCCESS_MAIL_MESSAGE = "転送成功";
	public static final String ERROR_MAIL_MESSAGE = "メール送信中にエラーが発生しました。";
	public static final String ERROR_MESSAGE = "ページが見つかりませんでした。";
}